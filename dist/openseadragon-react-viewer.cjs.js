...
var toolbarWrapper = core.css(_templateObject());
var toolbarControl = core.css(_templateObject2());
var osdToolbarDropdownWrapper = core.css(_templateObject3());
var osdToolbarDropdown = core.css(_templateObject4());
...
var Toolbar = function Toolbar(_ref) {
  ...
  return core.jsx("nav", null, core.jsx("button", {
    id: "zoom-in",
    "data-testid": "zoom-in",
    href: "#zoom-in",
    css: toolbarControl,
...
var dropdownSelectWrapper = core.css(_templateObject$1());
var reactSelectContainer = core.css(_templateObject2$1());
...
var TileSourceSelect = function TileSourceSelect(_ref) {
  ...
  return core.jsx("div", {
    ...
    theme: function theme(_theme) {
      return _objectSpread2(_objectSpread2({}, _theme), {}, {
        borderRadius: 0,
        colors: _objectSpread2(_objectSpread2({}, _theme.colors), {}, {
          primary: "#716c6b",
          primary50: "#d8d6d6",
          primary25: "#bbb8b8"
        })
...
var bottomPanel = function bottomPanel(props) {
  return core.css(_templateObject$2(), props);
};

var thumbnailView = core.css(_templateObject2$2());
var activeThumb = core.css(_templateObject3$1());
var panelListingThumbs = core.css(_templateObject4$1(), activeThumb, activeThumb);
...
function updateUrl(_ref) {
  var pan = _ref.pan,
      tileSourceIndex = _ref.tileSourceIndex,
      zoom = _ref.zoom;
  var currentUrlParams = new URLSearchParams(window.location.hash.slice(1));
...
var Viewer = function Viewer(_ref) {
  ...
  var handlePanZoomUpdate = function handlePanZoomUpdate() {
    if (openSeadragonInstance) {
      var pan = openSeadragonInstance.viewport.getCenter();
      var zoom = openSeadragonInstance.viewport.getZoom();
      updateUrl({
        pan: pan,
        zoom: zoom
      });
  ...
  var handleFullyLoaded = function handleFullyLoaded() {
    var urlParams = currentURLParams;
    var zoom = urlParams["zoom"] || openSeadragonInstance.viewport.getZoom();
    var pan = openSeadragonInstance.viewport.getCenter();
    var x = urlParams["x"] || pan.x;
  ...
  var handleDownloadCropClick = function handleDownloadCropClick() {
    var _calculateDownloadDim = calculateDownloadDimensions(),
        width = _calculateDownloadDim.width,
  ...
  var handleDownloadFullSize = function handleDownloadFullSize() {
    var _calculateDownloadDim2 = calculateDownloadDimensions(),
        width = _calculateDownloadDim2.width;

    var path = "".concat(currentTileSource.id, "/full/").concat(width, ",/0/default.jpg");
  ...
  function initOpenSeadragon() {
    ...
    setOpenSeadragonInstance(OpenSeadragon__default(_objectSpread2({
      ...
      sequenceMode: true,
      showFullPageControl: !reactDeviceDetect.isMobile,
      showNavigator: !reactDeviceDetect.isMobile,
  ...
  return core.jsx(React__default.Fragment, null, core.jsx("div", {
    ...
    css: topBar
  }, configProps.showDropdown && core.jsx("div", {
...
var notification = core.css(_templateObject$4());
var danger = core.css(_templateObject2$4());
