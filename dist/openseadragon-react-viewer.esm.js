...
var openSeadragonContainer = css$1(_templateObject$3());
var topBarWrapper = css$1(_templateObject2$3());
var topBar = css$1(_templateObject3$2());
var toolbar = css$1(_templateObject4$2());
/**
 * Viewer component
 */
...
var Viewer = function Viewer(_ref) {
  ...
  var _useState9 = useState(window.location.hash),
  ...
  function initOpenSeadragon() {
    ...
    setOpenSeadragonInstance(OpenSeadragon(_objectSpread2({
...
var wrapper = css$1(_templateObject$5()); // Instantiate FontAwesome icons
...
function OpenSeadragonViewer(_ref) {
  ...
  return manifest ? jsx(ConfigContext.Provider, {
    value: _objectSpread2({}, options)
  }, jsx(ErrorBoundary, null, jsx("div", {
    css: wrapper
  }, jsx(Viewer, {
    manifest: manifest
  })))) : null;
...
export { Notification, Thumbnails, TileSourceSelect, Toolbar };
